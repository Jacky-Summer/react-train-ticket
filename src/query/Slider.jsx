...
const Slider = memo(function Slider(props) {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      startHandle.current.removeEventListener('touchmove', onStartTouchMove, false) // eslint-disable-line
      endHandle.current.removeEventListener('touchstart', onEndTouchBegin, false)
      endHandle.current.removeEventListener('touchmove', onEndTouchMove, false) // eslint-disable-line
    }
  })
